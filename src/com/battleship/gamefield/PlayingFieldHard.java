...
public class PlayingFieldHard extends JPanel {
	private JPanel fields;

	private LeftFieldHard myOcean;
	private RightFieldHard enemyOcean;
	...
	public PlayingFieldHard(String gameTitle) {
...
class LeftFieldHard extends GridAreaHard {
	ShipPosition shipPositionLeft = new ShipPosition();

	public LeftFieldHard() {
		super("Home Field");
	}
...
class RightFieldHard extends GridAreaHard {
	private LeftFieldHard leftOcean;
...
//	Image fire = (new ImageIcon("graphics/fire.gif")).getImage();
//	Image water = (new ImageIcon("graphics/water.gif")).getImage();
	...
	public RightFieldHard() {
		super("Opponent Field");
		//leftOcean = new LeftFieldHard();
	...
	public void setPlayerOcean(LeftFieldHard leftOcean) {
	...
	private class MouseHandler extends MouseAdapter {
		int attackNum = 0;
		int attackState = 0;
		int myShipPosX[] = new int[12];
		int myShipPosY[] = new int[12];
		public void mousePressed(MouseEvent e) {
			if(e.getModifiers() == e.BUTTON1_MASK) {
				...
				for(int i=0; i<250; i=i+25){
					...
					myShipPosX[0] = getMyShipPos().getS1().getA().getX();
					myShipPosY[0] = getMyShipPos().getS1().getA().getY();
					myShipPosX[1] = getMyShipPos().getS1().getB().getX();
					myShipPosY[1] = getMyShipPos().getS1().getB().getY();
					myShipPosX[2] = getMyShipPos().getS1().getC().getX();
					myShipPosY[2] = getMyShipPos().getS1().getC().getY();
					myShipPosX[3] = getMyShipPos().getS1().getD().getX();
					myShipPosY[3] = getMyShipPos().getS1().getD().getY();
					myShipPosX[4] = getMyShipPos().getS2().getA().getX();
					myShipPosY[4] = getMyShipPos().getS2().getA().getY();
					myShipPosX[5] = getMyShipPos().getS2().getB().getX();
					myShipPosY[5] = getMyShipPos().getS2().getB().getY();
					myShipPosX[6] = getMyShipPos().getS2().getC().getX();
					myShipPosY[6] = getMyShipPos().getS2().getC().getY();
					myShipPosX[7] = getMyShipPos().getS3().getA().getX();
					myShipPosY[7] = getMyShipPos().getS3().getA().getY();
					myShipPosX[8] = getMyShipPos().getS3().getB().getX();
					myShipPosY[8] = getMyShipPos().getS3().getB().getY();
					myShipPosX[9] = getMyShipPos().getS4().getA().getX();
					myShipPosY[9] = getMyShipPos().getS4().getA().getY();
					myShipPosX[10] = getMyShipPos().getS4().getB().getX();
					myShipPosY[10] = getMyShipPos().getS4().getB().getY();
					myShipPosX[11] = getMyShipPos().getS4().getC().getX();
					myShipPosY[11] = getMyShipPos().getS4().getC().getY();
		...
		public int checkEnemyAttack(ShipPosition myShipPos) {
			...
			int maxHitCount = 200;
			if(attackNum % 3 == 0 && attackNum!=0){
				while(true){
					attachSuccess = false;

					int n = j.nextInt(12);
					currentLocEnemy = new Point(myShipPosX[n], myShipPosY[n]);
